...
.slds-select {
  ...
  width: 100%;
  border: 1px solid
    var(--slds-c-select-color-border, var(--sds-c-select-color-border, var(--slds-g-color-border-base-4, #c9c9c9)));
  border-radius: var(--slds-c-select-radius-border, var(--sds-c-select-radius-border, 0.25rem));
  background-color: var(
    --slds-c-select-color-background,
    var(--sds-c-select-color-background, var(--slds-g-color-neutral-base-100, white))
  );
...
.slds-select:active {
  ...
  border-color: var(
    ...
    var(--sds-c-select-color-border-focus, var(--slds-g-color-brand-base-60, #1b96ff))
  );
  background-color: var(
    --slds-c-select-color-background-focus,
    var(--sds-c-select-color-background-focus, var(--slds-g-color-neutral-base-100, white))
  );
