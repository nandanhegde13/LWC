...
.slds-slider__range::-webkit-slider-thumb {
  ...
  -webkit-box-shadow: var(
    ...
    var(--sds-c-slider-thumb-shadow, var(--slds-g-color-neutral-base-10, rgba(0, 0, 0, 0.16) 0 2px 3px))
  );
  box-shadow: var(
    --slds-c-slider-thumb-shadow,
    var(--sds-c-slider-thumb-shadow, var(--slds-g-color-neutral-base-10, rgba(0, 0, 0, 0.16) 0 2px 3px))
...
.slds-slider__range::-webkit-slider-runnable-track {
  ...
  background-color: var(
    ...
    var(--sds-c-slider-track-color-background, var(--slds-g-color-neutral-base-95, #f3f3f3))
  );
