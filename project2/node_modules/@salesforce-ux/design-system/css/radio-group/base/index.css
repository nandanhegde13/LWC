...
.slds-radio .slds-radio_faux {
  ...
  border: 1px solid
    var(--slds-c-radio-color-border, var(--sds-c-radio-color-border, var(--slds-g-color-border-base-4, #c9c9c9)));
  border-radius: 50%;
  background: none;
  background-color: var(
    --slds-c-radio-color-background,
    var(--sds-c-radio-color-background, var(--slds-g-color-neutral-base-100, white))
  );
...
.slds-radio [type="radio"]:checked + .slds-radio__label .slds-radio_faux {
  border-color: var(
    ...
    var(--sds-c-radio-color-border-checked, var(--sds-c-radio-color-border, var(--slds-g-color-border-base-4, #c9c9c9)))
  );
  background: none;
  background-color: var(
...
.slds-radio [type="radio"]:focus + .slds-radio__label .slds-radio_faux {
  border-color: var(
    ...
    var(--sds-c-radio-color-border-focus, var(--slds-g-color-brand-base-60, #1b96ff))
  );
...
[dir="rtl"] [dir="rtl"] .slds-form-element .slds-radio [type="radio"] ~ .slds-radio_faux,
[dir="rtl"] [dir="rtl"] .slds-radio [type="radio"] + .slds-radio__label .slds-radio_faux,
