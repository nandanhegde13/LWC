...
.slds-color-picker__custom-range:before {
  ...
  background: -webkit-gradient(
      ...
      left bottom,
      left top,
      from(var(--slds-g-color-neutral-base-10, black)),
      color-stop(1%, var(--slds-g-color-neutral-10-opacity-75, rgba(0, 0, 0, 0.9))),
      color-stop(99%, transparent)
    ),
    -webkit-gradient(linear, left top, right top, color-stop(1%, var(--slds-g-color-neutral-base-100, white)), to(transparent));
  background: linear-gradient(
      to top,
      var(--slds-g-color-neutral-base-10, black),
      var(--slds-g-color-neutral-10-opacity-75, rgba(0, 0, 0, 0.9)) 1%,
      transparent 99%
    ),
    linear-gradient(to right, var(--slds-g-color-neutral-base-100, white) 1%, transparent);
}
