  ...
  background-color: var(
    ...
    var(
      ...
      var(
        ...
        var(--sds-c-modal-color-background, var(--slds-g-color-neutral-base-100, white))
      )
    )
  );
...
.slds-modal__content {
  ...
  color: var(
    ...
    var(--sds-c-modal-content-text-color, var(--slds-c-modal-text-color, var(--sds-c-modal-text-color)))
  );
  overflow: hidden;
  overflow-y: auto;
}
...
.slds-modal__footer {
  ...
  background-color: var(
    ...
    var(
      ...
      var(
        --slds-c-modal-color-background,
        var(--sds-c-modal-color-background, var(--slds-g-color-neutral-base-95, #f3f3f3))
      )
    )
  );
  color: var(
    --slds-c-modal-footer-text-color,
    var(--sds-c-modal-footer-text-color, var(--slds-c-modal-text-color, var(--sds-c-modal-text-color)))
  );
  -ms-flex-negative: 0;
  flex-shrink: 0;
...
.slds-backdrop {
  ...
  background: var(
    ...
    var(--sds-c-backdrop-color-background, var(--slds-g-color-neutral-10-opacity-50, rgba(8, 7, 7, 0.6)))
  );
  z-index: 9000;
}
.slds-backdrop_open {
