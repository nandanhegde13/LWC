...
.slds-badge {
  ...
  background-color: var(
    ...
    var(--sds-c-badge-color-background, var(--slds-g-color-neutral-base-95, #f3f3f3))
  );
}
...
.slds-badge_inverse {
  ...
  --slds-c-badge-color-background: var(
    ...
    var(--sds-c-badge-inverse-color-background, var(--slds-g-color-neutral-base-50, #747474))
  );
  /*! @css-var-fallback color */
  --slds-c-badge-text-color: var(
    --slds-c-badge-inverse-text-color,
    var(--sds-c-badge-inverse-text-color, var(--slds-g-color-neutral-base-100, white))
  );
}
.slds-badge_lightest {
  /*! @css-var-fallback background-color */
  --slds-c-badge-color-background: var(
    ...
    var(--sds-c-badge-lightest-color-background, var(--slds-g-color-neutral-base-100, white))
  );
  /*! @css-var-fallback border-color */
  --slds-c-badge-color-border: var(
    --slds-c-badge-lightest-color-border,
    var(--sds-c-badge-lightest-color-border, var(--slds-g-color-border-base-1, #e5e5e5))
  );
}
.slds-badge__icon {
  display: -webkit-inline-box;
  ...
  color: var(
    ...
    var(--sds-c-badge-icon-color-foreground, var(--slds-g-color-neutral-base-50, #747474))
  );
  line-height: 1;
