...
.slds-pill {
  ...
  background-color: var(
    ...
    var(--sds-c-pill-color-background, var(--slds-g-color-neutral-base-100, white))
  );
...
.slds-pill_container {
  ...
  background-color: var(
    ...
    var(--sds-c-pill-container-color-background, var(--slds-g-color-neutral-base-100, white))
  );
}
...
.slds-pill__action:focus {
  outline: 0;
  border-color: var(
    --slds-c-pill-action-color-border,
    var(--sds-c-pill-action-color-border, var(--slds-g-color-brand-base-60, #1b96ff))
  );
...
.slds-has-error {
  border-color: var(
    ...
    var(--sds-c-pill-error-color-border, var(--slds-g-color-error-base-40, #ea001e))
  );
}
.slds-has-error:active {
  border-color: var(
    --slds-c-pill-error-color-border-active,
    var(--sds-c-pill-error-color-border-active, var(--slds-g-color-error-base-40, #ea001e))
  );
}
.slds-has-error .slds-pill__label {
  ...
  color: var(
    ...
    var(--sds-c-pill-error-text-color, var(--slds-g-color-error-base-40, #ea001e))
  );
}
