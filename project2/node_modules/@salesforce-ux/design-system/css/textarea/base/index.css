...
.slds-textarea {
  ...
  background-color: var(
    ...
    var(--sds-c-textarea-color-background, var(--slds-g-color-neutral-base-100, white))
  );
  color: var(--slds-c-textarea-text-color, var(--sds-c-textarea-text-color));
  border: 1px solid
    var(--slds-c-textarea-color-border, var(--sds-c-textarea-color-border, var(--slds-g-color-border-base-4, #c9c9c9)));
...
.slds-textarea:active {
  ...
  background-color: var(
    ...
    var(--sds-c-textarea-color-background-focus, var(--slds-g-color-neutral-base-100, white))
  );
  border-color: var(
    --slds-c-textarea-color-border-focus,
    var(--sds-c-textarea-color-border-focus, var(--slds-g-color-brand-base-60, #1b96ff))
  );
