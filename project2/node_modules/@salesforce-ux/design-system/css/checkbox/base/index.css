...
.slds-checkbox .slds-checkbox_faux {
  ...
  border-color: var(
    ...
    var(--sds-c-checkbox-color-border, var(--slds-g-color-border-base-4, #c9c9c9))
  );
  background-color: var(
    --slds-c-checkbox-color-background,
    var(--sds-c-checkbox-color-background, var(--slds-g-color-neutral-base-100, white))
  );
...
.slds-checkbox [type="checkbox"]:checked + .slds-checkbox__label .slds-checkbox_faux:after {
  ...
  border-bottom: 2px solid
    var(--slds-c-checkbox-mark-color-foreground, var(--sds-c-checkbox-mark-color-foreground, #0176d3));
  /*! @noflip */
...
.slds-checkbox [type="checkbox"]:focus + .slds-checkbox__label .slds-checkbox_faux {
  outline: 1px solid var(--slds-g-color-brand-base-80, #aacbff);
  outline-offset: 0px;
  /*! @css-var-fallback border-color */
  --slds-c-checkbox-color-border: var(
    --slds-c-checkbox-color-border-focus,
    var(--sds-c-checkbox-color-border-focus, var(--slds-g-color-brand-base-60, #1b96ff))
  );
