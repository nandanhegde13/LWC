...
@mixin inverse-text($support: null) {
  ...
  #{$link-selector} {
    ...
    &:focus {
      ...
      border: $border-width-thin solid var(--slds-g-color-neutral-base-100, #{$color-border-link-focus-inverse});
    }
...
@mixin warning-links {
  ...
  a {
    ...
    &:focus {
      box-shadow: 0 0 3px var(--slds-g-color-neutral-base-30, #{$color-gray-10});
