...
.slds-carousel__indicator-action {
  ...
  &:focus {
    @include focus-button;
    background-color: var(--slds-g-color-brand-base-30, #{$carousel-indicator-color-background-focus});
    border-color: var(--slds-g-color-brand-base-30, #{$carousel-indicator-color-background-focus});
    outline: 0;
  }
}
