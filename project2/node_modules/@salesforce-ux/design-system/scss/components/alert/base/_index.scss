...
.slds-notify--alert {
  ...
  a {
    ...
    &:focus {
      box-shadow: var(--slds-c-alert-shadow,
        0 0 3px var(--slds-g-color-neutral-base-100, #{$color-border-link-focus-inverse}));
      border-width: var(--slds-c-alert-sizing-border, $border-width-thin);
      border-style: solid;
      border-color: var(--slds-c-alert-color-border,
        var(--slds-g-color-neutral-base-100, #{$color-border-link-focus-inverse}));
    }
