...
.slds-progress--shade {
  ...
  .slds-progress__item {
    ...
    &.slds-is-active .slds-progress__marker {
      ...
      &:focus {
        box-shadow: var(--slds-g-color-neutral-base-95, #{$progress-color-background-shade}) 0 0 0 4px, 0 0 3px 4px
          var(--slds-g-color-brand-base-50, #{$color-border-brand-dark}); // Keeps white space and add blue focus ring
      }
    }
...
.slds-progress__item {
  ...
  &.slds-is-active .slds-progress__marker {
    ...
    &:focus {
      box-shadow: var(--slds-g-color-neutral-base-100, #{$progress-color-background}) 0 0 0 4px, 0 0 3px 4px var(--slds-g-color-brand-base-50, #{$color-border-brand-dark});
    }
  }
  ...
  &.slds-has-error .slds-progress__marker {
    ...
    &:focus {
      box-shadow: 0 0 3px 0 var(--slds-g-color-error-base-40, #{$color-border-error});
    }
  }
}
