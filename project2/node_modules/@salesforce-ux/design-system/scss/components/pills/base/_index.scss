...
.slds-pill {
  ...
  &:hover {
    ...
    --slds-c-pill-color-background: var(--sds-c-pill-color-background-hover, var(--slds-g-color-neutral-base-95, #{$color-background-button-default-hover}));
  }

  &:focus {
    /*! @css-var-fallback border-color */
    --slds-c-pill-color-border: var(--sds-c-pill-color-border-focus, var(--slds-g-color-brand-base-60, #{$color-border-input-active}));
...
.slds-pill__action {
  ...
  &:focus {
    outline: 0;
    border-color: var(--slds-c-pill-action-color-border, var(--sds-c-pill-action-color-border, var(--slds-g-color-brand-base-60, #{$color-border-input-active})));
