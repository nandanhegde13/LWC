  ...
  [type="radio"] {
    ...
    &:checked + .slds-radio__label .slds-radio--faux {
      ...
      &:after {
        ...
        border-radius: $border-radius-circle;
        background: none;
        background-color: var(--slds-c-radio-mark-color-foreground, var(--sds-c-radio-mark-color-foreground, $brand-accessible));
      }
    }
    ...
    &:focus + .slds-radio__label .slds-radio--faux {
      border-color: var(--slds-c-radio-color-border-focus, var(--sds-c-radio-color-border-focus, var(--slds-g-color-brand-base-60, #{$color-border-input-active})));
      box-shadow: var(--slds-c-radio-shadow-focus, var(--sds-c-radio-shadow-focus, $shadow-button-focus));
    }
