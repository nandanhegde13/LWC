...
@mixin button-shape($api-variant, $reassign: false) {
  @if $reassign == true {
    ...
    --slds-c-button-spacing-inline-start: var(--slds-c-button-#{$api-variant}-spacing-inline-start, var(--sds-c-button-#{$api-variant}-spacing-inline-start, #{$spacing-medium}));

    /*! @css-var-fallback padding-right */
    --slds-c-button-spacing-inline-end: var(--slds-c-button-#{$api-variant}-spacing-inline-end, var(--sds-c-button-#{$api-variant}-spacing-inline-end, #{$spacing-medium}));
  } @else {
