...
[kx-scope="button-neutral"] {
  ...
  &:active {
    ...
    background-color: var(--sds-c-button-neutral-color-background-hover, var(--slds-g-color-neutral-base-100, #{$button-color-background-primary}));
...
[kx-scope="button-outline"] {
  ...
  &:active {
    ...
    background-color: var(--sds-c-button-outline-brand-color-background, var(--slds-g-color-neutral-base-100, #{$button-color-background-primary}));
  }
}
