...
.slds-sub-tabs__item {
   ...
   */
  &.slds-has-warning {
    @include sub-tab-notification-before(var(--slds-g-color-warning-base-60, #{$color-background-warning}), var(--slds-g-color-warning-base-60, #{$color-background-warning-dark}));
