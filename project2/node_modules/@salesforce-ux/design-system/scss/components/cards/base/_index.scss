...
.slds-card__body--inner {
  ...
  --slds-c-card-body-spacing-inline-end: var(--sds-c-card-body-spacing-inline-end, var(--sds-c-card-body-spacing-inline, #{$var-spacing-horizontal-medium}));

  /*! @css-var-fallback padding-left */
  --slds-c-card-body-spacing-inline-start: var(--sds-c-card-body-spacing-inline-start, var(--sds-c-card-body-spacing-inline, #{$var-spacing-horizontal-medium}));
  padding-top: 0;
  padding-bottom: 0;
}
...
.slds-card__footer {
  ...
  padding-left:
    ...
    var(--slds-c-card-footer-spacing-inline,
    var(--sds-c-card-footer-spacing-inline, $var-spacing-horizontal-medium))));
  margin-top: var(--slds-c-card-footer-spacing-block-start, var(--sds-c-card-footer-spacing-block-start, $var-spacing-vertical-small));
