  ...
  [type='checkbox'] {
    ...
    &:focus {
      ...
      + .slds-checkbox--faux_container .slds-checkbox--faux {
        // @todo consider shared hooks for inputs
        /*! @css-var-fallback background-color */
        --slds-c-checkbox-toggle-color-background: var(--sds-c-checkbox-toggle-color-background-focus, var(--slds-g-color-neutral-base-50, #{$color-background-toggle-hover}));

        // @todo consider shared hooks for inputs
        /*! @css-var-fallback border-color */
        --slds-c-checkbox-toggle-color-border: var(--sds-c-checkbox-toggle-color-border-focus, var(--slds-g-color-brand-base-60, #{$color-border-input-active}));

        // @todo consider shared hooks for inputs
        /*! @css-var-fallback box-shadow */
        --slds-c-checkbox-toggle-shadow: var(--sds-c-checkbox-toggle-shadow-focus, #{$shadow-button-focus});
      }
    }
    ...
    &:checked {
      ...
      + .slds-checkbox--faux_container .slds-checkbox--faux {
        // @todo consider shared hooks for inputs
        /*! @css-var-fallback border-color */
        --slds-c-checkbox-toggle-color-border: var(--sds-c-checkbox-toggle-color-border-checked, #{$brand-accessible});
        // @todo consider shared hooks for inputs
        /*! @css-var-fallback background-color */
        --slds-c-checkbox-toggle-color-background: var(--sds-c-checkbox-toggle-color-background-checked, #{$brand-accessible});

        &:hover,
        &:focus {
          // @todo consider shared hooks for inputs
          /*! @css-var-fallback background-color */
          --slds-c-checkbox-toggle-color-background: var(--sds-c-checkbox-toggle-color-background-checked-hover, #{$brand-accessible-active});
        }
